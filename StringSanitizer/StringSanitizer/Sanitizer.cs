...
public static class Sanitizer
{
    ...
    /// multiple occurrence.
    /// <seealso cref="SanitizeExcessiveSpaces">To remove excessive spaces generated by removing emojis use SanitizeExcessiveSpaces</seealso>
    /// </summary>
    /// <param name="input">The string which you wish to run through the sanitizer</param>
    /// <param name="replacement">Override what is replaced. By default is ""</param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="input"></param>
    /// <param name="sanitizeSpaces">Sanitizes spaces. Use the <see cref="SanitizeSpaces"/>SanitizeSpaces enum
    /// set to false to not remove spaces.</param>
    /// <param name="replacement">Override what is replaced. By default is ""</param>
    /// <returns></returns>
